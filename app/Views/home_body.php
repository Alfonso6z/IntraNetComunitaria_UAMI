...
<body>
  ...
  <div class="rounded bordes" style="color: white; background:<?php echo $colorEncabezado?>">
    <div class="row container-fluid justify-content-center rounded m-0 mt-2 mb-2" style="background:transparent">
      <img class=" mt-2 m-0 ml-2 mb-2" src="img/fotos/FotoGrupo.png" alt="foto grupo" style="height: 16vh">
      <img class=" mt-2 m-0 ml-2 mb-2" src="https://upload.wikimedia.org/wikipedia/commons/7/7c/UAMI_CBI_NITE.JPG"
        alt="foto grupo" style="height: 16vh">
      <div class="row ml-3">
  ...
  <div class="row row-cols-2 ml-0 mb-2">
      ...
      <p class="text-justify lead textIntro font-italic font-weight-normal">
        ...
        <div class="container">
          ...
          <div id="demo" class="collapse">
            Basado en esta temática se propone la idea de la IntraNet como unas solución para mitigar estas necesidades.
            Su principal objetivo es llevar contenido digital para la comunidad UAM y a los alumnos que se encuentran
            viviendo alrededor de la unidad universitaria, ya que muchos ellos no cuentan con los recursos suficientes
            para tener acceso a Internet, proporcionando también otras formas de conexión desahogando el ancho de banda
            que existe de forma limitada.
            <ul>
    ...
    <div class="container rounded m-0">
      <div class="embed-responsive embed-responsive-16by9 rounded">
        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zdikOS9Er7s" frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  </div>
  <!-- Carrusel para resaltar anuncios importantes -->
